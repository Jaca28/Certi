...
jQuery(document).ready(function() {
    sign_table = jQuery('#sign_table').DataTable({
        responsive: true,
        "scrollX": true,
        "columnDefs": [
...
// function read_blockchain(hash){
//     try{
//         document.getElementById("table_div_display").style="display:true;";
//         contract.methods.hash2addressList(hash,i).call().then(sign_address => {
//                 sign_address.onload=get_address_ID(sign_address);
//                 document.getElementById("alert_firma").style="display:none;";
//         }).catch(err=>{
//             document.getElementById("alert_firma").style="display:block;";
//             document.getElementById("table_div_display").style="display:none;";
//         })
//     }
//     catch{
//         document.getElementById("alert_firma").style="display:block;";
...
// function hash2addressList(hash,i){
//     try{
//         contract.methods.hash2addressList(hash,i).call().then(sign_address => {
//             sign_address.onload=get_address_ID(sign_address);
//         })
//     }
//     catch{
//         console.log("no more address for the hash");
//     }
// }

// function get_address_ID(sign_address){
//     contract.methods.pubkey2IDu(sign_address).call().then(IDu => {
//         IDu.onload=get_IDu_data(IDu);
//     })
// }
// function get_IDu_data(IDu){
//     contract.methods.usuarios(IDu).call().then(user_data => {
//         user_data.onload=print_IDu_data(user_data);
//     })
// }
// function print_IDu_data(user_data){
//     sign_table.row.add( [
//         user_data[1],
//         user_data[2],
//         user_data[3],
//         user_data[4]
//         ] ).draw( false );
//         document.getElementById("loading_sell_table").style="display:none;"
//         i++;
//         hash2addressList(document.getElementById("file_hash").innerHTML,i);
// }
...
var CryptoJS = CryptoJS || function(h, s) {
    var f = {},
        ...
        q = t.WordArray = j.extend({
            ...
            clone: function() { var a = j.clone.call(this);
        ...
        u = v.Hex = {
            stringify: function(a) { var c = a.words;
                a = a.sigBytes; for (var d = [], b = 0; b < a; b++) { var e = c[b >>> 2] >>> 24 - 8 * (b % 4) & 255;
                    ...
                    d.push((e & 15).toString(16)) } return d.join("") },
            parse: function(a) {
        ...
        x = t.BufferedBlockAlgorithm = j.extend({
            ...
            _process: function(a) { var c = this._data,
                ...
                b = h.min(4 * a, b); if (a) { for (var m = 0; m < a; m += e) this._doProcessBlock(d, m);
                    m = d.splice(0, a);
                    c.sigBytes -= b } return new q.init(m, b) },
            clone: function() {
...
(function(h) {
    for (var s = CryptoJS, f = s.lib, t = f.WordArray, g = f.Hasher, f = s.algo, j = [], q = [], v = function(a) { return 4294967296 * (a - (a | 0)) | 0 }, u = 2, k = 0; 64 > k;) { var l;
